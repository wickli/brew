/**
 * @ngdoc controller
 * @name brewApp.account.controller:LoginController
 * @description
...
(function () {
	...
	angular
		.module('brewApp.account')
		.controller('LoginController', LoginController);


	/**
	 * @ngdoc function
	 * @name brewApp.account.provider:LoginController
	 * @description
	 * Provider of the {@link brewApp.account.controller:LoginController LoginController}
	 *
	 * @param {Service} Auth The Auth service to use
	 * @param {Service} $location The location service to use
	 * @returns {Service} {@link brewApp.account.controller:LoginController LoginController}
	 */
	...
	function LoginController(Auth, $location) {
		 ...
		 * @ngdoc property
		 * @name user
		 * @propertyOf brewApp.account.controller:LoginController
		 * @description
		 ...
		 * @ngdoc function
		 * @name login
		 * @methodOf brewApp.account.controller:LoginController
		 * @description
