/**
 * @ngdoc overview
 * @name brewApp.admin.user.list.detail
 * @description
 * The `brewApp.admin.user.list.detail` module which provides:
 *
 * - {@link brewApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
 *
 * @requires ui.router
 * @requires angularMoment
 * @requires brewApp.auth.user
 */
(function () {
	'use strict';
