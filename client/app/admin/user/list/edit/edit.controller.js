/**
 * @ngdoc controller
 * @name brewApp.admin.user.list.edit.controller:UserEditController
 * @description
...
(function () {
	...
	/**
	 * @ngdoc function
	 * @name brewApp.admin.user.list.edit.provider:UserEditController
	 * @description
	 * Provider of the {@link brewApp.admin.user.list.edit.controller:UserEditController UserEditController}
