/**
 * @ngdoc overview
 * @name brewApp.admin.user.create
 * @description
 * The `brewApp.admin.user.create` module which provides
 *
 * - {@link brewApp.admin.user.create.controller:UserCreateController UserCreateController}
 *
 * @requires ui.router
 * @requires ngMaterial
 * @requires ngMessages
