/**
 * @ngdoc controller
 * @name brewAppproduct.list.edit.controller:ProductEditController
 * @description
...
(function () {
	...
	angular
		.module('brewApp.product.list.edit')
		.controller('ProductEditController', ProductEditController);

	/**
	 * @ngdoc function
	 * @name brewAppproduct.list.edit.provider:ProductEditController
	 * @description
	 * Provider of the {@link brewAppproduct.list.edit.controller:ProductEditController ProductEditController}
