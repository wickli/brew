...
describe('Controller: BasketDetailController', function () {

	// load the controller's module
	beforeEach(module('brewApp.list.detail'));
	...
	beforeEach(inject(function ($state) {
		...
		basket = {_id: '1337id', name: 'admin', active: true};
	}));

	// Initialize the controller and a mock scope
	beforeEach(inject(function ($controller) {
		controller = $controller('BasketDetailController', {
			user: user
		});
	}));
	...
	it('should have a user property which is the current basket', function () {
