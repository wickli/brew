/**
 * @ngdoc controller
 * @name brewApp.controller:AppController
 * @description
 * This is the application wide controller of the brewApp application
 */
...
(function () {
	...
	/**
	 * @ngdoc function
	 * @name brewApp.provider:AppController
	 * @description
	 * Provider of the {@link brewApp.controller:AppController AppController}
	 *
	...
	function AppController(Auth, $mdSidenav) {
		 ...
		 * @ngdoc function
		 * @name logout
		 * @methodOf brewApp.controller:AppController
		 * @description
