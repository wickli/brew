...
describe('Controller: CartDetailController', function () {
	...
	beforeEach(inject(function ($state) {
		...
		cart = {_id: '1337id', name: 'admin', active: true};
	}));

	// Initialize the controller and a mock scope
	beforeEach(inject(function ($controller) {
		controller = $controller('CartDetailController', {
			user: user
		});
	}));
	...
	it('should have a user property which is the current cart', function () {
